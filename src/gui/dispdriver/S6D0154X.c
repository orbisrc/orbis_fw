...
{
	S6D0154X_WR_REG(REG_Y_SET, X1);
	S6D0154X_WR_REG(REG_X_SET, Y1);

	S6D0154X_WR_REG(REG_HORIZONTAL_END, X2);
	S6D0154X_WR_REG(REG_HORIZONTAL_START, X1);
	S6D0154X_WR_REG(REG_VERTICAL_END, Y2);
	S6D0154X_WR_REG(REG_VERTICAL_START, Y1);
	...
	HAL_SPI_Transmit(&S6D0154X_SPI, (uint8_t *)buff, (X2 - X1 + 1) * (Y2 - Y1 + 1) * 2, 100);
