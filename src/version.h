...
#define FW_VERSION_MINOR            2  // increment when a minor release is made (small new feature, change etc)
#define FW_VERSION_PATCH_LEVEL      4  // increment when a bug is fixed
...
#define PCB_VERSION_PATCH_LEVEL      6  // increment when a bug is fixed
