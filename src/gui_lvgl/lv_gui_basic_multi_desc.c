...
void lv_multi_desc_init()
{
    ...
    sub_protocols_opts[PROTO_FLYSKY] = (char *)sub_protocol_flysky;
    sub_protocols_opts[PROTO_HUBSAN] = (char *)sub_protocol_hubsan;
    sub_protocols_opts[PROTO_FRSKYD] = (char *)sub_protocol_frskyd;
    sub_protocols_opts[PROTO_HISKY] = (char *)sub_protocol_hisky;
    sub_protocols_opts[PROTO_V2X2] = (char *)sub_protocol_v2x2;
    sub_protocols_opts[PROTO_DSM] = (char *)sub_protocol_dsm;
    sub_protocols_opts[PROTO_YD717] = (char *)sub_protocol_yd717;
    sub_protocols_opts[PROTO_KN] = (char *)sub_protocol_kn;
    sub_protocols_opts[PROTO_SYMAX] = (char *)sub_protocol_symax;
    sub_protocols_opts[PROTO_SLT] = (char *)sub_protocol_slt;
    sub_protocols_opts[PROTO_CX10] = (char *)sub_protocol_cx10;
    sub_protocols_opts[PROTO_CG023] = (char *)sub_protocol_cg023;
    sub_protocols_opts[PROTO_BAYANG] = (char *)sub_protocol_bayang;
    sub_protocols_opts[PROTO_FRSKYX] = (char *)sub_protocol_frskyx;
    sub_protocols_opts[PROTO_ESKY] = (char *)sub_protocol_esky;
    sub_protocols_opts[PROTO_MT99XX] = (char *)sub_protocol_mt99xx;
    sub_protocols_opts[PROTO_MJXQ] = (char *)sub_protocol_mjxq;
    sub_protocols_opts[PROTO_SHENQI] = NULL;
    sub_protocols_opts[PROTO_FY326] = (char *)sub_protocol_fy326;
    ...
    sub_protocols_opts[PROTO_HONTAI] = (char *)sub_protocol_hontai;
    sub_protocols_opts[PROTO_OPENLRS] = NULL;
    sub_protocols_opts[PROTO_AFHDS2A] = (char *)sub_protocol_afhds2a;
    sub_protocols_opts[PROTO_Q2X2] = (char *)sub_protocol_q2x2;
    sub_protocols_opts[PROTO_WK2x01] = (char *)sub_protocol_wk2x01;
    sub_protocols_opts[PROTO_Q303] = (char *)sub_protocol_q303;
    sub_protocols_opts[PROTO_GW008] = NULL;
    sub_protocols_opts[PROTO_DM002] = NULL;
    sub_protocols_opts[PROTO_CABELL] = (char *)sub_protocol_cabell;
    sub_protocols_opts[PROTO_ESKY150] = (char *)sub_protocol_esky150;
    sub_protocols_opts[PROTO_H8_3D] = (char *)sub_protocol_h8_3d;
    sub_protocols_opts[PROTO_CORONA] = (char *)sub_protocol_corona;
    sub_protocols_opts[PROTO_CFLIE] = NULL;
    sub_protocols_opts[PROTO_HITEC] = (char *)sub_protocol_hitec;
    sub_protocols_opts[PROTO_WFLY] = NULL;
    sub_protocols_opts[PROTO_BUGS] = NULL;
    sub_protocols_opts[PROTO_BUGSMINI] = (char *)sub_protocol_bugsmini;
    sub_protocols_opts[PROTO_TRAXXAS] = (char *)sub_protocol_traxxas;
    sub_protocols_opts[PROTO_NCC1701] = NULL;
    sub_protocols_opts[PROTO_E01X] = (char *)sub_protocol_e01x;
    sub_protocols_opts[PROTO_V911S] = (char *)sub_protocol_v911s;
    sub_protocols_opts[PROTO_GD00X] = (char *)sub_protocol_gd00x;
    sub_protocols_opts[PROTO_V761] = (char *)sub_protocol_v761;
    sub_protocols_opts[PROTO_KF606] = (char *)sub_protocol_KF606;
    sub_protocols_opts[PROTO_REDPINE] = (char *)sub_protocol_redpine;
    sub_protocols_opts[PROTO_POTENSIC] = NULL;
    sub_protocols_opts[PROTO_ZSX] = NULL;
    sub_protocols_opts[PROTO_HEIGHT] = (char *)sub_protocol_height;
    sub_protocols_opts[PROTO_SCANNER] = NULL;
    sub_protocols_opts[PROTO_FRSKY_RX] = (char *)sub_protocol_frsky_rx;
    sub_protocols_opts[PROTO_AFHDS2A_RX] = NULL;
    sub_protocols_opts[PROTO_HOTT] = (char *)sub_protocol_hott;
    sub_protocols_opts[PROTO_FX816] = NULL;
    sub_protocols_opts[PROTO_BAYANG_RX] = NULL;
    sub_protocols_opts[PROTO_PELIKAN] = (char *)sub_protocol_pelikan;
    sub_protocols_opts[PROTO_TIGER] = NULL;
    sub_protocols_opts[PROTO_XK] = (char *)sub_protocol_xk;
    sub_protocols_opts[PROTO_XN297DUMP] = (char *)sub_protocol_xn297dump;
    sub_protocols_opts[PROTO_FRSKYX2] = NULL;
    sub_protocols_opts[PROTO_FRSKY_R9] = (char *)sub_protocol_frsky_r9;
    sub_protocols_opts[PROTO_PROPEL] = NULL;
    sub_protocols_opts[PROTO_FRSKYL] = (char *)sub_protocol_frskyl;
    sub_protocols_opts[PROTO_SKYARTEC] = NULL;
    sub_protocols_opts[PROTO_ESKY150V2] = NULL;
    sub_protocols_opts[PROTO_DSM_RX] = NULL;
    sub_protocols_opts[PROTO_JJRC345] = (char *)sub_protocol_JJRC345;
    sub_protocols_opts[PROTO_Q90C] = NULL;
    sub_protocols_opts[PROTO_KYOSHO] = (char *)sub_protocol_kyosho;
    sub_protocols_opts[PROTO_RLINK] = (char *)sub_protocol_RLINK;
    ...
    sub_protocols_opts[PROTO_MOULDKG] = (char *)sub_protocol_MOULDKG;
